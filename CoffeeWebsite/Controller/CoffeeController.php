...
function showConfirm(id)
{
		...
		//if true delete and refresh item
		if(c)
...
//Contains non-db related func for the Cofee page
...
class CoffeeController
{
	...
	function CreateCoffeeDropdownList()
	{
		...
		<select name = 'types' >
		<option value = '%' >aLL</option>".$this->CreateOptionValues($coffeeModel->GetCoffeeTypes()).
